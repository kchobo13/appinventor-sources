...
import com.google.appinventor.client.editor.youngandroid.palette.YoungAndroidPaletteVRPanel;
 ...
 */
public final class YaVREditor extends DesignerEditor<YoungAndroidVRNode, MockForm,
    YoungAndroidPaletteVRPanel, SimpleComponentDatabase> {
  ...
  /**
   * Creates a new YaVREditor.
   *
   * @param projectEditor  the project editor that contains this file editor
   * @param formNode the YoungAndroidVRNode associated with this YaVREditor
   */
  YaVREditor(ProjectEditor projectEditor, YoungAndroidVRNode formNode) {
    ...
    palettePanel = new YoungAndroidPaletteVRPanel(this);
  ...
  @Override
  public void onHide() {
    OdeLog.log("YaVREditor: got onHide() for " + getFileId());
    ...
    if (Ode.getInstance().getCurrentFileEditor() == this) {
      ...
      OdeLog.wlog("YaVRmEditor.onHide: Not doing anything since we're not the "
          + "current file editor!");
    }
  }
