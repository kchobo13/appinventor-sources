...
public class YoungAndroidSourceAnalyzer {
  ...
  public static final String VR_SRC_FOLDER = "vr";
  ...
  /**
   * The filename extension for the file that contains data to be consumed
   * by the VR editors.
   */
  public static final String VREDITOR_PROPERTIES_EXTENSION = ".json";
