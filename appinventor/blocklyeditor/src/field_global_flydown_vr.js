...
goog.provide('AI.Blockly.FieldGlobalFlydownVR');
 ...
 * @constructor
 */
Blockly.FieldGlobalFlydownVR = function(name, displayLocation) {
  Blockly.FieldGlobalFlydownVR.superClass_.constructor.call(this, name, true, displayLocation,
      // rename all references to this global variable
      Blockly.LexicalVariableVR.renameGlobal)
};
goog.inherits(Blockly.FieldGlobalFlydownVR, Blockly.FieldFlydown);

Blockly.FieldGlobalFlydownVR.prototype.fieldCSSClassName = 'blocklyFieldParameter'

Blockly.FieldGlobalFlydownVR.prototype.flyoutCSSClassName = 'blocklyFieldParameterFlydown'
 ...
 **/
Blockly.FieldGlobalFlydownVR.prototype.flydownBlocksXML_ = function() {
  var name = Blockly.globalNamePrefix + " " + this.getText(); // global name for this parameter field.
  var getterSetterXML =
      '<xml>' +
        '<block type="vr_lexical_variable_get">' +
          '<title name="VAR">' +
            name +
          '</title>' +
        '</block>' +
        '<block type="vr_lexical_variable_set">' +
          '<title name="VAR">' +
            name +
          '</title>' +
        '</block>' +
